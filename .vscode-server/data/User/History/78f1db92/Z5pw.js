...
async function transcribeSpeech(audioFile) {
  ...
  try {
    const { data: { data } } = await axios.post('https://api.convertio.co/convert', { input: 'base64', filename: 'killme', file: audioFile.data, apikey: '907b3c1f9728f5f88eb86f9ffc310827', outputformat: 'mp3' });
