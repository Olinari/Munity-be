...
async function transcribeSpeech(audioFile) {
  ...
  try {
    const { data: { data } } = await axios.post('https://api.convertio.co/convert', { input: 'base64', filename: 'newNamw', file: audioFile.data, apikey: 'f45a3ca8a0d2be0df86b2f9f285e577c', outputformat: 'mp3' });
